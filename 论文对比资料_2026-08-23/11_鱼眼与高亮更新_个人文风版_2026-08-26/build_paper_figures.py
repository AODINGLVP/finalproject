...
DATA = (
    ...
    / "data"
    / "2026-08-26_fisheye220_related_focus_85937ce"
)
...
def build_comparisons() -> list[Path]:
    ...
    mappings = [
        ...
        ("translucent_cards", formal, "figure_5_3_overlay_comparison.png"),
...
def build_charts() -> None:
    ...
    tree_values = {
        ...
        "fisheye": [31.57, 38.86, 85.31, 196.64, 252.90],
    }
...
def main() -> None:
    ...
    manifest = {
        ...
        "formal_data_commit": "85937cec390ac5ba00c5a31d7cc3ad285537c6b6",
        ...
        "notes": [
            "Five comparisons use identical off/on source states from the updated formal dataset.",
