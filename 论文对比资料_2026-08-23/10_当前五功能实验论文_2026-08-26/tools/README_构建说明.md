...
- `行为树论文_中文_当前五功能实验版.docx`
- `行为树论文_中文_当前五功能实验版.pdf`
- `Behaviour_Tree_Dissertation_English_Current_Five_Features.pdf`
...
```powershell
.\论文对比资料_2026-08-23\10_当前五功能实验论文_2026-08-26\tools\build.ps1 -UpdateWordFields
```
...
```powershell
.\论文对比资料_2026-08-23\10_当前五功能实验论文_2026-08-26\tools\build.ps1 -SkipPdf
```

运行不保留成品的完整自测：

```powershell
.\论文对比资料_2026-08-23\10_当前五功能实验论文_2026-08-26\tools\build.ps1 -SelfTest
```

只检查当前 Markdown 语法和必需元数据、完全不创建文档：

```powershell
.\论文对比资料_2026-08-23\10_当前五功能实验论文_2026-08-26\tools\build.ps1 -ValidateOnly
```
