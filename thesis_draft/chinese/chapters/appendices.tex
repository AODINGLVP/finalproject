...
\begin{description}
    ...
    \item[多规模显示汇总：] \path{testgame/testgame/test_results/multiscale_display_summary.csv}
    \item[多规模显示脚本：] \path{testgame/testgame/tests/run_multiscale_display_experiment.gd}
