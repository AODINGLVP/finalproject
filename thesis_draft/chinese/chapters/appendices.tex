...
协议包含六种显示条件，每种三个任务。参与者先完成统一练习，再进行 18 个平衡顺序试验。软件记录条件、树规模、目标、时间、误选、Zoom、Pan 和成功率；每种条件后给出七点可读性与认知负荷评分。工作簿支持 15 人、270 行。当前没有参与者数据。使用前必须获得所需伦理许可，与导师确认流程，并保证同意和退出程序符合学校要求。
