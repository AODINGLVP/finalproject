...
\begin{description}
    ...
    \item[物理屏幕实验协议：] \path{research/display_optimization/physical_screen_size_experiment/}
    \item[物理屏幕原始数据：] \path{research/display_optimization/physical_screen_size_experiment/data/2026-08-23_three_displays/combined_raw.csv}
    \item[物理屏幕汇总：] \path{research/display_optimization/physical_screen_size_experiment/data/2026-08-23_three_displays/screen_size_comparison.csv}
    \item[物理屏幕报告：] \path{research/display_optimization/physical_screen_size_experiment/data/2026-08-23_three_displays/report_zh.md}
