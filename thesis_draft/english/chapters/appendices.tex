...
The prepared study contains six display conditions and three tasks per condition. A participant first completes a standardised practice task, then performs 18 counterbalanced trials. The software records condition, tree size, target, completion time, incorrect selections, zoom count, pan count and success. After each condition, the participant gives seven-point readability and cognitive-load ratings. The workbook supports up to 15 participants and 270 rows.
