...
\section{Plugin Functionality and Playable-Game Validation}
...
\begin{table}[htbp]
\centering
\caption{Complex-tree coverage on three physical screen sizes. Resolution is audit metadata, not an experimental treatment.}
...
\midrule
BOE0CD1, 15.94 inches & (34\times22) & (1190\times770) & 18.32\% & 12.13\% & 116.38x & 184.13x \\
H27T22S, 26.96 inches & (60\times33) & (2100\times1155) & 38.61\% & 25.57\% & 43.96x & 69.56x \\
U32G3X, 31.55 inches & (70\times39) & (2450\times1365) & 46.53\% & 30.82\% & 31.89x & 50.45x \\
\bottomrule
\end{tabular}
}
\end{table}
...
\section{Results for the Research Question}

Functionality testing and the playable game confirmed that the experimental platform could correctly author, save and execute behaviour trees. This is a prerequisite for the display experiment, not a result that this dissertation investigates independently.

Data from five node scales and three screen sizes show that the six display conditions consistently change card density, displayed context and the prominence of a search target while preserving node positions, parent--child relationships and execution order. The experimental data support the conclusion that these optimisations improve some measurable display and editing-interaction properties of large behaviour trees. Because there were no human participants, this study cannot additionally claim that human readability or use efficiency has been demonstrated.
